...
List<dynamic> generateVerticalMonthGrid(int firstWeekday, int totalDays) {
  ...
  int remainingEmptyCells = firstWeekday; // Number of leading empty cells before the 1st day starts
  int overflowDays = totalDays - (35 - firstWeekday); // Days that don’t fit in 5 columns and wrap to the top
  ...
  for (int i = 0; i < verticalCalendarGrid.length; i++) {
    ...
    int rowPosition = (i / 7).toInt(); // Converts division result to int (drops decimal)
